!(function (e, t) {
    ...
    getOrInitializeService({ instanceIdentifier: e, options: t = {} }) {
      ...
      if (
        ...
        ((r = this.component.instanceFactory(this.container, {
          instanceIdentifier: (n = e) === b ? void 0 : n,
          options: t,
        })),
  ...
  function R(n) {
    return n !== IDBDatabase.prototype.transaction ||
      ...
      ? (L = L || [
        ...
        ? function (...e) {
            return n.apply(H(this), e), j(N.get(this));
          }
        : function (...e) {
            return j(n.apply(H(this), e));
          }
      : function (e, ...t) {
          var r = n.call(H(this), e, ...t);
          return T.set(r, e.sort ? e.sort() : [e]), j(r);
        };
  }
  function $(e) {
    ...
    if (e instanceof IDBRequest)
      return (function (i) {
        ...
        return (
          e
            .then((e) => {
              e instanceof IDBCursor && N.set(e, i);
            })
            .catch(() => {}),
          M.set(e, i),
          e
  ...
  k = {
    ...(I = k),
    get: (e, t, r) => x(e, t) || I.get(e, t, r),
    has: (e, t) => !!x(e, t) || I.has(e, t),
  };
  class W {
    constructor(e) {
      this.container = e;
  ...
  function ee(e) {
    ...
    if (q.has(t))
      return (
        G.debug(`There were multiple attempts to register component ${t}.`), !1
      );
    q.set(t, e);
    for (const r of X.values()) Z(r, e);
    return !0;
  }
  function te(e, t) {
    const r = e.container
  ...
  class ne {
    ...
    checkDestroyed() {
      if (this.isDeleted)
        throw re.create("app-deleted", { appName: this._name });
    }
  }
  const ae = "9.8.2";
  function ie(e, t = {}) {
    ...
    var r = Object.assign({ name: J, automaticDataCollectionEnabled: !1 }, t);
    const n = r.name;
    if ("string" != typeof n || !n)
      throw re.create("bad-app-name", { appName: String(n) });
    var a = X.get(n);
    if (a) {
      if (p(e, a.options) && p(r, a.config)) return a;
      throw re.create("duplicate-app", { appName: n });
    }
    const i = new _(n);
    for (const s of q.values()) i.addComponent(s);
    r = new ne(e, r, i);
    return X.set(n, r), r;
  }
  async function se(e) {
  ...
  function oe(e, t, r) {
    ...
    ee(new m(`${n}-version`, () => ({ library: n, version: t }), "VERSION"));
  }
  function ce(e, t) {
    if (null !== e && "function" != typeof e)
      throw re.create("invalid-log-argument");
    !(function (i, e) {
      for (const t of E) {
        let a = null;
        e && e.level && (a = w[e.level]),
          (t.userLogHandler =
            null === i
              ? null
              : (e, t, ...r) => {
  ...
  const le = "firebase-heartbeat-database",
    pe = 1,
    ...
    return (
      (ue =
        ...
        (function (
          ...
          return (
            n &&
              s.addEventListener("upgradeneeded", (e) => {
                n(j(s.result), e.oldVersion, e.newVersion, j(s.transaction));
              }),
          ...
          throw re.create("storage-open", { originalErrorMessage: e.message });
        })),
      ue
    );
  }
  async function ge(e, t) {
    try {
      const r = await fe(),
        n = r.transaction(de, "readwrite"),
        a = n.objectStore(de);
      return await a.put(t, me(e)), n.done;
    } catch (e) {
      throw re.create("storage-set", { originalErrorMessage: e.message });
    }
  }
  function me(e) {
      ...
      var e = ve(),
        { heartbeatsToSend: t, unsentEntries: r } = (function (e, t = 1024) {
          ...
          for (const a of e) {
            ...
            if (i) {
              if ((i.dates.push(a.date), Ee(r) > t)) {
                i.dates.pop();
                break;
              }
            } else if (
              (r.push({ agent: a.agent, dates: [a.date] }), Ee(r) > t)
            ) {
              r.pop();
              break;
            }
      ...
      return (
        ((await this._canUseIndexedDBPromise) &&
          (await (async function (e) {
            try {
              const t = await fe();
              return t.transaction(de).objectStore(de).get(me(e));
            } catch (e) {
              throw re.create("storage-get", {
  ...
  (K = ""),
    ee(new m("platform-logger", (e) => new W(e), "PRIVATE")),
    ee(new m("heartbeat", (e) => new be(e), "PRIVATE")),
    oe(U, "0.7.25", K),
    oe(U, "0.7.25", "esm2017"),
    oe("fire-js", "");
  var ye = Object.freeze({
    ...
    _components: q,
    _getProvider: te,
    _registerComponent: ee,
    _removeServiceInstance: function (e, t, r = J) {
      te(e, t).clearInstance(r);
    },
    deleteApp: se,
    getApp: function (e = J) {
      var t = X.get(e);
      if (!t) throw re.create("no-app", { appName: e });
      return t;
    },
    getApps: function () {
  ...
  class Ie {
    constructor(e, t) {
      (this._delegate = e),
        (this.firebase = t),
        Z(e, new m("app-compat", () => this, "PUBLIC")),
    ...
    delete() {
      return new Promise((e) => {
        ...
        () => (this.firebase.INTERNAL.removeApp(this.name), se(this._delegate))
      );
    }
    _getService(e, t = J) {
      var r;
  ...
  const we = new o("app-compat", "Firebase", {
    "no-app":
      "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()",
    "invalid-app-argument":
      "firebase.{$appName}() takes either no argument or a Firebase App instance.",
  ...
  function Ce(a) {
              ...
              ee(r) &&
                ...
                ((e = (e = o()) => {
                  if ("function" != typeof e[t])
                    throw we.create("invalid-app-argument", { appName: n });
                  return e[t]();
                }),
    ...
    function o(e) {
      if (((e = e || J), !l(i, e))) throw we.create("no-app", { appName: e });
      return i[e];
    }
    return (
      (s.default = s),
  ...
  const Se = new S("@firebase/app-compat");
  if (
    "object" == typeof self &&
    self.self === self &&
  ...
  `);
    const Ae = self.firebase.SDK_VERSION;
    Ae &&
      0 <= Ae.indexOf("LITE") &&
      Se.warn(`
  ...
  const Oe = De;
  oe("@firebase/app-compat", "0.1.26", void 0);
  return Oe.registerVersion("firebase", "9.8.2", "app-compat-cdn"), Oe;
});
